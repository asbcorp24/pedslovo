...
<footer class="footer py-5 mt-5"><div class="container"><div class="row"><div class="col-lg-7"><div class="h5">ПЕДСЛОВО</div><p class="mb-0 text-white-50">{{ $footerText }}</p></div><div class="col-lg-5 text-lg-end mt-3 mt-lg-0">@if($contactPhone)<div>{{ $contactPhone }}</div>@endif @if($contactEmail)<div>{{ $contactEmail }}</div>@endif</div></div></div></footer>
