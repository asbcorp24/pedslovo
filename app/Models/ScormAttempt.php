...
class ScormAttempt extends Model {
 protected $fillable=['scorm_package_id','user_id','status','score_raw','score_min','score_max','lesson_location','suspend_data','session_time','total_time','cmi_data','started_at','completed_at'];
