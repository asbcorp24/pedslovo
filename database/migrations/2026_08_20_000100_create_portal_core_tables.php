...
return new class extends Migration {
 public function up(){
  ...
  Schema::create('material_section',function(Blueprint $t){$t->foreignId('material_id')->constrained()->cascadeOnDelete();$t->foreignId('section_id')->constrained()->cascadeOnDelete();$t->timestamps();$t->primary(['material_id','section_id']);});
 }
